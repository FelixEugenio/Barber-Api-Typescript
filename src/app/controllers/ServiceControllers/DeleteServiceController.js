...
const DeleteServiceServices_1 = require("../../services/ServiceServices/DeleteServiceServices");
class DeleteServiceController {
    handle(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const id = req.params.id;
            const deleteServiceService = new DeleteServiceServices_1.DeleteServiceServices();
